...
const profiles = [
  {
    name: "Ahmed Eid",
    role: "Graphic Designer , Flutter & Leader  And  CEO NabdMasr",
    date: "2024-09-08",
  ...
  {
    name: "Seif Ayman",
    role: "Front-End Developer, React & Next.js Enthusiast, CTO NabdMasr",
    date: "2024-09-08",
    ...
    <>
      <section className="w-[80%] mx-auto mt-20">
        <main className="pt-8 pb-16 lg:pt-16 lg:pb-24 antialiased">
          <div className="grid gap-8 grid-cols-1 md:grid-cols-2 px-6 py-8 mx-auto max-w-screen-xl">
          ...
          <div className="bg-gradient-to-tl from-white/10 via-white/5 to-white/10 backdrop-blur-lg p-6 rounded-xl shadow-lg text-white grid grid-cols-2 grid-rows-2 gap-4">
            {/* Top Left */}
            ...
            {/* Right (Full Height) */}
            <div className="row-span-2 p-6 bg-black/30 backdrop-blur-lg rounded-xl shadow-lg text-white">
            ...
            {/* Bottom (Full Width) */}
            <div className="col-span-2 p-4 bg-black/30 rounded-lg">
          ...
          <table className="w-full mb-8 bg-white/10 backdrop-blur-md rounded-lg shadow-lg">
